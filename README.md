...
*Feb 2025 – Jun 2025*
* Developed a crowdsourcing platform for malware analysis integrating WhatsApp and Hybrid Analysis.
* Built an internal HR platform featuring RBAC and CV Builder, containerized with Docker.
* Managed deployment lifecycles and technical documentation using GitLab.
...
>
> *Solution:* Built a backend system with **Role-Based Access Control (RBAC)**. I containerized the app using **Docker** to ensure it runs consistently across dev and production servers.
>
> *Key Features:*
> * Dynamic CV Builder
...
>
> [🔗 View Project](https://github.com/penanamtomat/project-pemweb/tree/master)
